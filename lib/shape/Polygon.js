    ...
    value: function render() {
      ...
      if (layerClass.indexOf('recharts-polar-angle-axis') === -1) {
        for (var i = 0; i < points.length; i++) {
          svgPoints.push(_react2.default.createElement('circle', {
            cx: points[i].x,
            cy: points[i].y,
            r: 6,
            stroke: '#E0E0E0',
      ...
      return _react2.default.createElement(
        ...
        null,
        svgPoints,
        _react2.default.createElement('polygon', _extends({}, (0, _ReactUtils.getPresentationAttributes)(this.props), (0, _ReactUtils.filterEventAttributes)(this.props), {
